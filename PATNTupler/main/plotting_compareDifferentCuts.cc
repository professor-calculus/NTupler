...
int main(){
    ...
    // ONE: save info
    std::string outputDir = "/opt/ppd/scratch/xap79297/Analysis_boostedNmssmHiggs/plots_2017_06_13/ttbarShape/loWithoutTheInclusiveBitNoLheCut_sample_ht2500to3500_followsTheCutFlow_75_0_300/"; // where we are going to save the output plots (should include the samples name + binning maybe)
    ...
    std::vector<int> cut3_ak8Pt = {170, 300};
	...
	TH1F hTemplate("hTemplate", ";LeadingBDiscFatJet_SoftDrop_Mass (GeV);a.u.", 75, 0, 300);
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////////////////
    std::string saveName = "moveThroughCuts";
