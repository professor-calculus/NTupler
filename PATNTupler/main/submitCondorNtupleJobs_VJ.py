...
inputFileListPath = baseDir + "/src/NTupler/PATNTupler/fileLists/8_0_31/TTWtoQQ.list"
outputDirectory = "/opt/ppd/scratch/titterton/Analysis_boostedNmssmHiggs/flatTrees_MHT_2019_01_08_FULL/other_mc/TTWtoQQ/" # has to be the full path
