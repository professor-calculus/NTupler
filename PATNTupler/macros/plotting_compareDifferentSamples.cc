...
int main(int argc, char** argv){
    ...
    // std::vector<std::vector<std::string>> cut2_ak8Dbt = { {"Off","Med2","Off","Med2"} }; // 4 elements in sub-vector: 1st for fatJetA min, 2nd for fatJetA max, 3rd for fatJetB min, 4th for fatJetB max --> "Off", "Loose", "Med1", "Med2", "Tight", "Max"
    ...
    // TH1F hTemplate("hTemplate", ";fatJetA_SoftDrop_Mass (GeV);events/bin", 50, 0, 200);
    // TH1F hTemplate("hTemplate", ";fatJetB_SoftDrop_Mass (GeV);a.u.", 50, 0, 200);
    // TH1F hTemplate("hTemplate", ";fatJetB_SoftDrop_Mass (GeV);events/bin", 50, 0, 200);
    // TH1F hTemplate("hTemplate", ";fatJetA_doubleBtagDiscrim;a.u.", 50, -1.0, 1.0);
    // TH1F hTemplate("hTemplate", ";fatJetA_doubleBtagDiscrim;events/bin", 50, -1.0, 1.0);
    // TH1F hTemplate("hTemplate", ";fatJetB_doubleBtagDiscrim;a.u.", 50, -1.0, 1.0);
    // TH1F hTemplate("hTemplate", ";fatJetB_doubleBtagDiscrim;events/bin", 50, -1.0, 1.0);
    ...
    // TH1F hTemplate("hTemplate", ";fatJetA p_{T} (GeV);a.u.", 50, 0.0, 2000.0);
    // TH1F hTemplate("hTemplate", ";fatJetA p_{T} (GeV);events/bin", 50, 0.0, 2000.0);
    // TH1F hTemplate("hTemplate", ";fatJetB p_{T} (GeV);a.u.", 50, 0.0, 2000.0);
    // TH1F hTemplate("hTemplate", ";fatJetB p_{T} (GeV);events/bin", 50, 0.0, 2000.0);
