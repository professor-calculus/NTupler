...
int main(int argc, char** argv){
    ...
    // ONE: save info
    std::string outputDir = "/opt/ppd/scratch/xap79297/Analysis_boostedNmssmHiggs/histos_2017_09_28_CMSSW_8_0_29_dbtV4/MassCutsV04/Data_JetHt2016_goldenJson_NOAK4/tag_UnDonly/"; // where we are going to save the output plots (should include the samples name + binning maybe)
    ...
    for (size_t iCut2 = 0; iCut2 < cut2_ak8Dbt.size(); ++iCut2){
        ...
        for (size_t iMassRegion = numberOfSegments; iMassRegion!=3*numberOfSegments; ++iMassRegion){ // TO AVOID LOOKING IN THE S REGION!!!
            ...
            for (size_t iCut4 = 0; iCut4 < cut4_ht.size(); ++iCut4){
                ...
                plotEntry.AddInput("/opt/ppd/scratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2017_09_27_CMSSW_8_0_29_dbtV4/data/JetHt_Run2016_goldenJson_ht1500plus/flatTree.root", cutToApply.c_str());
