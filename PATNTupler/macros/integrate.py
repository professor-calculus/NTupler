...
for i in range(0, len(three_x_points_vec)-1):
	...
	# print "2016 ht3500toInfMC F_" + str(iMR) + " = " + str(ratio__antiS_over_antiUnD__fullCuts_anti_ht3500toInf_2016MC)
	...
	# print "2017 ht3500toInfMC F_" + str(iMR) + " = " + str(ratio__antiS_over_antiUnD__fullCuts_anti_ht3500toInf_2017MC)
