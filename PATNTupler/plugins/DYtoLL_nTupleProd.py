...
config.General.requestName = 'dy_nTuple_production'
...
config.Data.outLFNDirBase = '/store/user/olaiya/NTuples/DY' #Wherever you want the ntuples to go on the RAL T2
config.Data.publication = False
config.Data.publishDataName = 'DY_nTuple_PROD'
