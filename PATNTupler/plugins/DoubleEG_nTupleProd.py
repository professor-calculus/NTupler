...
config.General.requestName = 'DoubleEG_nTuple_production'
...
config.Data.outLFNDirBase = '/store/user/olaiya/NTuples/DoubleEG' #Wherever you want the data to go on the RAL T2
config.Data.publication = False
config.Data.publishDataName = 'DoubleEG_nTuple_PROD'
