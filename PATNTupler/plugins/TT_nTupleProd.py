...
config.General.requestName = 'tt_nTuple_production'
...
config.Data.outLFNDirBase = '/store/user/olaiya/NTuples/TT' #Wherever you want the ntuples to go on the RAL T2
config.Data.publication = False
config.Data.publishDataName = 'TT_nTuple_PROD'
