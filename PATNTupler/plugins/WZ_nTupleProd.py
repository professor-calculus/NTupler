...
config.General.requestName = 'wz_nTuple_production'
...
config.Data.outLFNDirBase = '/store/user/olaiya/NTuples/WZ' #Wherever you want the ntuples to go on the RAL T2
config.Data.publication = False
config.Data.publishDataName = 'WZ_nTuple_PROD'
